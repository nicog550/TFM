...
var GameGenerator = function() {
    var constants = require('./constants'),
        core = this.core(constants, getSockets, setWord),
        round = 0,
...
/**
 * Class responsible for the creation of a new game TODO: update this JSDoc
 * @param constants
 * @param getSockets
 * @param setWord
 * @returns {{createNewGame: createNewGame}}
 */
GameGenerator.prototype.core = function(constants, getSockets, setWord) {
